...
local_parameters = [{'name': 'camera_name', 'default': 't265', 'description': 'camera unique name'},
                    ...
                    {'name': 'tracking_module.frames_queue_size', 'default': '32', 'description': 'meh'},
                    {'name': 'tracking_module.enable_pose_jumping', 'default': 'false', 'description': 'meh'},
                   ]
